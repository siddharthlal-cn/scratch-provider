...
import (
	...
	"github.com/siddharthlal-cn/scratch-provider/apis"
	"github.com/siddharthlal-cn/scratch-provider/pkg/controller"
)
...
func main() {
	...
	log := logging.NewLogrLogger(zl.WithName("scratch-provider"))
	if *debug {
